...
(function ( $ ) {
  $.fn.canvasClock = function( options ) {
    ...
    // create colck
    var create_digital_clock = function( _this, time_zone, date_format, city_name, lang, lang_for_date, show_days ) {
      ...
      if( parseInt( date_format ) === 24 ) {
        ...
        element_time.text( date.toLocaleString('en', {hour12: true, timeZone: time_zone, hour: '2-digit', minute: '2-digit', second: '2-digit' }) );
      ...
      if( canvasClock.digital_clock !== true ) {
        ...
        clockImage.onload = function() {
          ...
          window.setInterval( function() {
            ...
            // show days
            console.log(canvasClock.show_days === 'true');
        ...
        window.setInterval( function() {
          ...
          create_digital_clock( _this, canvasClock.time_zone, canvasClock.date_format, canvasClock.city_name, canvasClock.lang, canvasClock.lang_for_date, canvasClock.show_days );
