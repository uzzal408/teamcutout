...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="tile">
            ...
            <form action="{{ route('admin.departments.update') }}" method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12" id="dropzone">
                                <div>Image [Width: 100px, Height: 100px; File Size: Maximum 8KB]</div>
...
{{--                            <div class="col-md-10">--}}
{{--                                <label class="control-label">Image [Width: 100px, Height: 100px; File Size: Maximum 8KB]</label>--}}
{{--                                <input class="form-control @error('image') is-invalid @enderror" type="file" id="image" name="image" />--}}
{{--                                @error('image') {{ $message }} @enderror--}}
{{--                            </div>--}}
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12" id="dropzone_ic">
                                <div>Inner Page Image [Width: 640px, Height: 426px; File Size: Maximum 70KB]</div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                @if ($t_page->icon != null)
                                <figure class="mt-2" style="width: 80px; height: auto;">
                                    <img src="{{ asset('storage/'.$t_page->icon) }}" id="icon" class="img-fluid" alt="icon">
                                </figure>
                                @endif
                            </div>
{{--                            <div class="col-md-10">--}}
{{--                                <label class="control-label">Inner Page Image [Width: 640px, Height: 426px; File Size: Maximum 70KB]</label>--}}
{{--                                <input class="form-control @error('icon') is-invalid @enderror" type="file" id="icon" name="icon" />--}}
{{--                                @error('icon') {{ $message }} @enderror--}}
{{--                            </div>--}}
                        </div>
                ...
                <div class="tile-footer">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a class="btn btn-secondary" href="{{ route('admin.departments.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                </div>
            </form>
        </div>
    </div>
