                ...
                <form action="{{ route('admin.packages.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="page_id">Select Page<span class="m-l-5 text-danger"> *</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('original_price') is-invalid @enderror" type="text" name="original_price" id="original_price" value="{{ old('original_price') }}"/>
                            <input type="hidden" name="site_id" value="{{ session()->get('site_id') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('save') is-invalid @enderror" type="text" name="save" id="save" value="{{ old('save') }}"/>
                            <input type="hidden" name="site_id" value="{{ session()->get('site_id') }}">
