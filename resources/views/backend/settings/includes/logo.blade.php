        ...
        <div class="tile-body">
            ...
            <div class="row mt-4">
                <div class="col-3">
                    ...
                    <img src="{{ asset('storage/'.config('settings.footer_logo')) }}" id="footerImg" style="width: 80px; height: auto;">
                    @else
                    <img src="https://via.placeholder.com/80x80?text=Placeholder+Image" id="footerImg" style="width: 80px; height: auto;">
                    @endif
                </div>
                <div class="col-9">
                    <div class="form-group">
                        <label class="control-label">Footer logo [Width: 211px, Height: 64px; File Size Maximum 20KB]</label>
                        <input class="form-control" type="file" name="footer_logo" onchange="loadFile(event,'footerImg')" />
                    </div>
                </div>
            </div>
