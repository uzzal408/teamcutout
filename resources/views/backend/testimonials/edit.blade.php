...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="tile">
            ...
            <form action="{{ route('admin.testimonials.update') }}" method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('age') is-invalid @enderror" type="text" name="age" id="age" value="{{ old('age',$t_list->age) }}" />
                        <input type="hidden" name="site_id" value="{{ session()->get('site_id') }}">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" id="status" name="status" {{ (old('status',$t_list->status)) == 1 ? 'checked' : '' }} />Enable
                            </label>
                        </div>
                    </div>
