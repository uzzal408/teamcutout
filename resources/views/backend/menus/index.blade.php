...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.menus.create') }}" class="btn btn-primary pull-right">Add New Menu</a>
    </div>
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        @foreach($menus as $key=>$menu)
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $menu->title }}</td>
                                <td>{{ $menu->site->name }}</td>
                                <td>{{ (isset($menu->parent->title)) ?  $menu->parent->title : ' ' }}</td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        ...
                                        <a onclick="return confirm('Are you sure?')" href="{{ route('admin.menus.delete', $menu->id) }}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
