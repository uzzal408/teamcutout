...
{{--    <link rel='stylesheet' href='https://mverissimo.github.io/tweenslideshow/dist/assets/stylesheet/application.min.css'>--}}
...
{{--<link href="../fonts.googleapis.com/css5a81.css?family=Raleway:400%2C600%2C500%7CRoboto:400" rel="stylesheet" property="stylesheet" media="all" type="text/css" >--}}

{{--<script type='text/javascript' src='{{ asset('frontend/js/jquery/ui/core.mine899.js?ver=1.11.4') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('frontend/js/jquery/ui/widget.mine899.js?ver=1.11.4') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('frontend/js/jquery/ui/accordion.mine899.js?ver=1.11.4') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('frontend/js/jquery/ui/position.mine899.js?ver=1.11.4') }}'></script>--}}

.............................
{{--<script type='text/javascript' src='{{ asset('frontend/js/jquery/ui/menu.mine899.js?ver=1.11.4') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('frontend/js/wp-a11y.min8fc0.js?ver=4.6.23') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('frontend/js/jquery/ui/autocomplete.mine899.js?ver=1.11.4') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('frontend/wp-includes/js/jquery/ui/button.mine899.js?ver=1.11.4') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('frontend/wp-includes/js/jquery/ui/datepicker.mine899.js?ver=1.11.4') }}'></script>--}}
